...
4. 查看 RAG 技巧命中、素材缺口、迁移映射、竖屏分镜和时间线草案。
...
| 结构迁移 | 多版本脚本、迁移映射、样例节拍到新方案镜头 |
| 素材缺口 | 结构槽位诊断、缺口影响、补全策略 |
...
- 项目的核心结构定义、素材槽位、缺口补全、迁移映射、质量门禁和前端工作流为自主设计与实现。
