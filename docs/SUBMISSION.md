...
8. 展示“迁移映射”，说明每段新脚本如何继承样例规则，以及素材缺口怎么被处理。
9. 展示“质量诊断”，用综合评分和推荐版本回答为什么这个方案可上交。
10. 在自然语言编辑里输入“开头更抓人一些，并补充可信证据”，展示方案可被人工协同调整。
11. 点击 Markdown 导出，说明产物可以进入 Obsidian、剪辑协作或二期视频合成链路。
