...
| 结果可验证 | 秒级时间线草案、9:16 分镜预览、版本切换、Markdown/JSON 导出 | “时间线草案”“竖屏分镜预览”和导出按钮 |
...
9. 展示“迁移映射”，说明每段新脚本如何继承样例规则，以及素材缺口怎么被处理。
10. 展示“质量诊断”，用综合评分和推荐版本回答为什么这个方案可上交。
11. 在自然语言编辑里输入“开头更抓人一些，并补充可信证据”，展示方案可被人工协同调整。
12. 点击 Markdown 导出，说明产物可以进入 Obsidian、剪辑协作或二期视频合成链路。
