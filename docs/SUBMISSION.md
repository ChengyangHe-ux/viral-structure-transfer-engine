...
5. 停留在“素材缺口与补全”，指出缺少对比/结果镜头和 CTA 镜头时，系统给出包装补全和素材复用策略。
6. 展示“时间线草案”，说明脚本已经按秒拆成可生产时间线。
7. 展示“迁移映射”，说明每段新脚本如何继承样例规则，以及素材缺口怎么被处理。
8. 展示“质量诊断”，用综合评分和推荐版本回答为什么这个方案可上交。
9. 在自然语言编辑里输入“开头更抓人一些，并补充可信证据”，展示方案可被人工协同调整。
10. 点击 Markdown 导出，说明产物可以进入 Obsidian、剪辑协作或二期视频合成链路。
